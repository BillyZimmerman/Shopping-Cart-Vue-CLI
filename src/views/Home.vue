<template>
  ...
  <main class="wrapper">
    ...
    <div class="recommended">
      ...
      <!-- USING SLICE TO ONLY SHOW THE FIRST 3 ITEMS AVAILABLE  -->
      <div v-for='(product, i) in inventory.slice(0,3)' :key="product.id" class="card">
        ...
        <div class="card-body">
          ...
          <form>
            ...
            <div class="row">
              ...
              <div class="cell">
                <!-- .number CONVERTS A STRING TO A NUMBER VALUE -->
        ...
        <div class="card-footer">
          <!-- WHEN SOMEONE CLICKS THE ADDTOCART BUTTON IT WILL UPDATE THE CART  -->
